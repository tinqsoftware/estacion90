...
<body>
        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                ...
                @php $isAdmin = auth()->user()->id_rol == 1; @endphp
                @if($isAdmin)
                <div class="mb-4">
    ...
    $(document).ready(function() {
        ...
        const createModalEl = document.getElementById('crearMenuModal');
        const editModalEl = document.getElementById('editarMenuModal');
        ...
        $(document).on('click', '.view-menu-btn', function() {
            ...
            const nombre = menuRow.find('td:eq(1)').text();
            const precio = menuRow.find('td:eq(2)').text();
            const budgets = menuRow.find('td:eq(3)').text();
        ...
        <div class="row mb-2 nueva-categoria" data-index="${contadorCategorias}">
            <div class="col-md-5">
                <input type="text" class="form-control" name="nuevas_categorias[${contadorCategorias}][nombre]" placeholder="Nombre de budget" required>
            </div>
            <div class="col-md-5">
    ...
    `;
        ...
        $('.selectpicker').selectpicker({
            ...
            noneSelectedText: 'Selecciona budgets...',
            countSelectedText: function(numSelected, numTotal) {
                return (numSelected == 1) ? numSelected + ' budget seleccionado' : numSelected +
                    ' budgets seleccionados';
            }
        });
